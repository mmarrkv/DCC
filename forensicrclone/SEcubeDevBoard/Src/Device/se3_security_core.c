...
#include "se3_algo_ChaCha20Poly1305.h" //frclone
#include "se3_common.h"

se3_crypto_algorithm_t se3_crypto_algorithm;
...
se3_algo_descriptor algo_table[SE3_ALGO_MAX] = {
		...
		B5_AES_256 },
	{
		...
		B5_AES_256 },
	{   //frclone
	    mv_algo_ChaCha20Poly1305_init,
        mv_algo_ChaCha20Poly1305_update,
        sizeof(MV_tChaCha20Poly1305Ctx),
        "ChaChaPolyBAKE",
        SE3_CRYPTO_TYPE_STREAMCIPHER,
        MV_CHACHA20POLY1305_MAC_SIZE,
        MV_CHACHA20POLY1305_KEY_256 },
	{ NULL, NULL, 0, "", 0, 0, 0 },
	{ NULL, NULL, 0, "", 0, 0, 0 }
};
...
union {
    B5_tSha256Ctx sha;
    B5_tAesCtx aes;
    MV_tChaCha20Poly1305Ctx chacha; //frclone
} ctx;
