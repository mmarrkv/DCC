...
#include "sha256.h"
#include "pbkdf2.h"
#include "chacha20poly1305.h" //frclone
#include "pcr.h" //frclone
...
typedef enum {
	...
	SE3_PBKDF2,
	SE3_SHA256,
	MV_CHACHA20POLY1305 //frclone
}se3_crypto_algorithm_t;

extern se3_crypto_algorithm_t se3_crypto_algorithm;
...
typedef struct se3_payload_cryptoctx_ {
    ...
    MV_tChaCha20Poly1305Ctx chachaenc; //frclone
    MV_tChaCha20Poly1305Ctx chachadec;
